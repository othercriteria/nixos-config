...
Not a from-scratch host step. The service and vhost are declarative;
event setup (htpasswd secret, TLS smoke test, round staging) is in
[Trivia setup](runbooks/trivia-setup.md).
