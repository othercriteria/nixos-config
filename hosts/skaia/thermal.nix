...

{
  ...
  hardware.fancontrol = {
    ...
    config = ''
      ...
      MAXTEMP=hwmon14/pwm7=70 hwmon14/pwm5=70 hwmon14/pwm3=70 hwmon14/pwm2=70
      MINSTART=hwmon14/pwm7=150 hwmon14/pwm5=150 hwmon14/pwm3=150 hwmon14/pwm2=150
      MINSTOP=hwmon14/pwm7=100 hwmon14/pwm5=100 hwmon14/pwm3=100 hwmon14/pwm2=0
    '';
  };
}
